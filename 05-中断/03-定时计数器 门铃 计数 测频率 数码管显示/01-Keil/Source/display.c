...
unsigned char LEDBuf[] = {8,8,8,8,8,8};   //数据显示缓冲区
unsigned char code PLACE_CODE[] = {0xfb,0xf7,0xef,0xdf,0xbf,0x7f}; //共阴，位选信号
